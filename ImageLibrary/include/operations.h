...
/**	compare 2 images.
 *	@param	image1	    RasterImage struct of the image 1.
 *  @param  image2      RasterImage struct of the image 2.
 *  @return Return a 1 if images the same, 0 if images are different.
 */
 ...
 *	@param	image1	    RasterImage struct of the image 1.
 *  @param  image2      RasterImage struct of the image 2.
 *  @return Return a 1 if images are less that 5% different, 0 if images are more than that.
 */
int compareFz(RasterImage* image1, RasterImage* image2);

/**	compare 2 images dimensions.
 *	@param	image1	    RasterImage struct of the image 1.
 *  @param  image2      RasterImage struct of the image 2.
 *  @return Return a boolean, true image the same, false images are different.
 */
